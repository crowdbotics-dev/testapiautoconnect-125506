...
## Project Structure
    ...
    ├── testapiautoconnect_125506  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_125506`
...
2. Clone this repo and `cd testapiautoconnect_125506`
